 ...
 */
public class RestLauncher {  //http://localhost:9992/rest

	public static final URI BASE_URI = getBaseURI();

	private static URI getBaseURI() {
     	return UriBuilder.fromUri("http://0.0.0.0/rest/").port(9992).build();
	}

	public static void main(String[] args) throws IOException {
	    ResourceConfig resourceConfig = new ResourceConfig();
		resourceConfig.registerClasses(RestResource.class,CrossDomainFilter.class);
